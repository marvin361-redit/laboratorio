...
public class UsuarioServiceImpl implements UsuarioService {
    ...
    @Override
    public UsuarioDto editar(Long id, usuairoDto){
        Usiario UsiarioExistente = usuarioRepository.findById(id).orElseThrow(() -> new RuntimeException("Usuario no encontrado con ID: " + id));
